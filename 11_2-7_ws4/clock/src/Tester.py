...
def runtest(executable_file, test_data):
    ...
    out, _ = p.communicate(bytes(input_to_test.encode(
        "utf-8")) + bytes('\n'.encode('utf-8')) + bytes(offset_to_test.encode("utf-8")))
...
offset1.txt"""
    ...
    expected_output = """\
Before noon"""
    return 1, input_to_test, offset_to_test, expected_output
...
offset2.txt"""
    ...
    expected_output = """\
After noon"""
    return 2, input_to_test, offset_to_test, expected_output
...
offset3.txt"""
    ...
    expected_output = """\
High noon"""
    return 3, input_to_test, offset_to_test, expected_output
